...
function showSlot(slot) {
	...
	$("#example_video_1").replaceWith('<iframe id="example_video_1" src="'+slot.source+'?autoplay=1&controls=0&amp;showinfo=0" width="640" height="480" frameborder="0"></iframe>');
	
	intervalAd = setInterval(function() {
		$(".skipBtn").click();
		clearInterval(intervalAd);
	},videoTag.duration*100 + 500);
